...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=128, n_layers=4, norm_layer=nn.InstanceNorm2d):
        ...
        sequence += [nn.utils.spectral_norm(nn.Conv2d(ndf * nf_mult*2, 1, kernel_size=4, stride=1, padding=1))]  # output 1 channel prediction map
...
if __name__ == '__main__':
    ...
    #     print('**'*100)
    #     for subsubnet in subnet.children():
    #         print('##'*20)
    #         print(subsubnet)
