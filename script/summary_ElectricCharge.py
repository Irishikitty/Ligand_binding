...
# read directly ---------------
f = open('df_charge_dict.json')
df_charge_dict = json.load(f)
f.close()
...
positive_ligand = open("./charge/df_"+temp+"_pos.pkl", "wb")
pickle.dump(df_positive_ligand, positive_ligand)
positive_ligand.close()

negative_ligand = open("./charge/df_"+temp+"_neg.pkl", "wb")
pickle.dump(df_negative_ligand, negative_ligand)
negative_ligand.close()

neuter_ligand = open("./charge/df_"+temp+"_neu.pkl", "wb")
